...
<?php require "layouts/header.php"; ?>
    ...
    <main>
        <!-- placeholder form for now, will do something similar to the symfonycasts form for pets
         this doesn't work at all just general idea of what form will/should look like-->
